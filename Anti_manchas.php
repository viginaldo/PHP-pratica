...
<body>
    ...
    <section>
        <div class="container">
            <section class="banner3">
                <img src="img/cicatriz.webp" alt="Anti-Manchas">
            </section>
            <div class="container-txt">
                <h2 class="tit">Anti-Manchas</h2>
                <p>O Anti-Manchas é ideal para reduzir manchas e uniformizar o tom da pele. <strong>Como usar:</strong> Aplique o creme na área afetada uma vez por dia, massageando suavemente até a absorção completa.</p>
                <br>
                <p class="sec">Promove uma pele mais uniforme e com aparência rejuvenescida.</p>
                <div class="container-card">
                    <div class="acction">
                        <a href="payment.php?medicamento=<?php echo urlencode("Anti Manchas"); ?>&preco=<?php echo urlencode(375.50); ?>">
    ...
    <section class="produtos-info">
        ...
        <div class="grid-container">
            <div class="card">
                <img src="img/antim.png" alt="Alternativa 1">
                <h3 class="nam">Melora Antimanchas</h3>
                <p class="desc">
                    <ul>
                        <li>Redução visível das manchas</li>
                        <li>Ideal para peles com hiperpigmentação</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/vichy.png" alt="Alternativa 2">
                <h3 class="nam">Vichy Ideal White</h3>
                <p class="desc">
                    <ul>
                        <li>Uniformiza o tom da pele</li>
                        <li>Com ácido hialurônico e vitamina C</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/posay.png" alt="Alternativa 3">
                <h3 class="nam">La Roche-Posay Pigmentclar</h3>
                <p class="desc">
                    <ul>
                        <li>Reduz manchas escuras</li>
                        <li>Para todos os tipos de pele</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/even.png" alt="Alternativa 4">
                <h3 class="nam">Eucerin Even Brighter</h3>
                <p class="desc">
                    <ul>
                        <li>Ilumina e uniformiza a pele</li>
                        <li>Com ácido glicólico</li>
                    </ul>
                </p>
            </div>
        </div>
