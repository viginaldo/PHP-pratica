...
<head>
    ...
    <title>Corine De Farme-Baby</title>
</head>
<body>
    <header>
        <div class="logo">
    ...
    <section>
        <div class="container">
            <section class="banner3">
                <img src="img/bebe 3.jpg" alt="Corine De Farme-Baby">
            </section>
            <div class="container-txt">
                <h2 class="tit">Corine De Farme-Baby</h2>
                <p>Hidratante suave e seguro para a pele delicada dos bebês. <strong>Como usar:</strong> Aplique no corpo do bebê após o banho para manter a pele macia e hidratada.</p>
                <br>
                <p class="sec">Ideal para peles sensíveis e testado dermatologicamente.</p>
                <div class="container-card">
                    <div class="acction">
                        <a href="payment.php?medicamento=<?php echo urlencode("Corine De Farme"); ?>&preco=<?php echo urlencode(245); ?>">
    ...
    <section class="produtos-info">
        ...
        <div class="grid-container">
            <div class="card">
                <img src="img/locao.png" alt="Alternativa 1">
                <h3 class="nam">Loção Hidratante para Bebês</h3>
                <p class="desc">
                    <ul>
                        <li>Hidratação suave</li>
                        <li>Sem fragrância</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/gel-calmante.png" alt="Alternativa 2">
                <h3 class="nam">Gel Calmante para Bebês</h3>
                <p class="desc">
                    <ul>
                        <li>Alivia irritações</li>
                        <li>Com extrato de camomila</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/nutri.png" alt="Alternativa 3">
                <h3 class="nam">Creme Nutritivo para Bebês</h3>
                <p class="desc">
                    <ul>
                        <li>Hidratação profunda</li>
                        <li>Com óleo de amêndoas</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/natural.png" alt="Alternativa 4">
                <h3 class="nam">Loção Natural para Bebês</h3>
                <p class="desc">
                    <ul>
                        <li>Sem parabenos</li>
