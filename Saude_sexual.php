...
<head>
    ...
    <title>Saúde Sexual para Homens c/30 doses</title>
</head>
<body>
    <header>
        <div class="logo">
    ...
    <section>
        <div class="container">
            <section class="banner3">
                <img src="img/sex1.png" alt="Saúde Sexual para Homens c/30 doses">
            </section>
            <div class="container-txt">
                <h2 class="tit">Saúde Sexual para Homens c/30 doses</h2>
                <p>Este suplemento é formulado para apoiar a saúde sexual masculina, promovendo o aumento da libido e a melhora da função sexual. <strong>Como usar:</strong> Tomar 1 dose diária, preferencialmente antes de uma refeição, ou conforme orientação médica.</p>
                <br>
                <p class="sec">Ajudar a manter o desempenho sexual e promover uma sensação geral de bem-estar.</p>
                <div class="container-card">
                    <div class="acction">
                        <a href="payment.php?medicamento=<?php echo urlencode("Saude Sexual"); ?>&preco=<?php echo urlencode(200.00); ?>">
    ...
    <section class="produtos-info">
        ...
        <div class="grid-container">
            <div class="card">
                <img src="img/xtraman.png" alt="Alternativa 1">
                <h3 class="nam">XtraMan Suplemento Sexual</h3>
                <p class="desc">
                    <ul>
                        <li>Para aumento da libido</li>
                        <li>Melhora a performance sexual</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/xforte.png" alt="Alternativa 2">
                <h3 class="nam">Erección Forte</h3>
                <p class="desc">
                    <ul>
                        <li>Suplemento para a função sexual</li>
                        <li>Aumenta o fluxo sanguíneo</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/vig.png" alt="Alternativa 3">
                <h3 class="nam">VigRX Plus</h3>
                <p class="desc">
                    <ul>
                        <li>Suplemento natural para desempenho sexual</li>
                        <li>Aumenta a confiança e o desejo sexual</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/testomax.png" alt="Alternativa 4">
                <h3 class="nam">TestoMax</h3>
                <p class="desc">
                    <ul>
                        <li>Melhora os níveis de testosterona</li>
                        <li>Ideal para a saúde sexual masculina</li>
                    </ul>
                </p>
            </div>
        </div>
