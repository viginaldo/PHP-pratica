    ...
    <section>
        <div class="container">
            <section class="banner3">
                <img src="img/gel.png" alt="Gel De Banho - Nivea">
            </section>
            <div class="container-txt">
                <h2 class="tit">Gel De Banho - Nivea</h2>
                ...
                <div class="container-card">
                    <div class="acction">
                        <a href="payment.php?medicamento=<?php echo urlencode("Gel De Banho"); ?>&preco=<?php echo urlencode(400.00); ?>">
