...
<head>
    ...
    <title>ATL Babu - Muda de Fralda</title>
</head>
<body>
    <header>
        <div class="logo">
    ...
    <section>
        <div class="container">
            <section class="banner3">
                <img src="img/bebe 4.png" alt="ATL Babu - Muda de Fralda">
            </section>
            <div class="container-txt">
                <h2 class="tit">ATL Babu - Muda de Fralda</h2>
                <p>Produto suave e eficaz para limpar e proteger a pele delicada dos bebês durante a troca de fraldas. <strong>Como usar:</strong> Aplique com o auxílio de um algodão na área a ser limpa, sem enxaguar.</p>
                <br>
                <p class="sec">Ideal para peles sensíveis e propensas a irritação.</p>
                <div class="container-card">
                    <div class="acction">
                        <a href="payment.php?medicamento=<?php echo urlencode("ATL Baby"); ?>&preco=<?php echo urlencode(400); ?>">
    ...
    <section class="produtos-info">
        ...
        <div class="grid-container">
            <div class="card">
                <img src="img/toalhitas.png" alt="Alternativa 1">
                <h3 class="nam">Toalhitas Húmidas para Bebês</h3>
                <p class="desc">
                    <ul>
                        <li>Limpeza prática e rápida</li>
                        <li>Hipoalergênico</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/pomada_antiassaduras.png" alt="Alternativa 2">
                <h3 class="nam">Pomada Antiassaduras</h3>
                <p class="desc">
                    <ul>
                        <li>Protege contra assaduras</li>
                        <li>Fórmula suave</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/locao.png" alt="Alternativa 3">
                <h3 class="nam">Loção Hidratante para Bebês</h3>
                <p class="desc">
                    <ul>
                        <li>Hidratação delicada</li>
                        <li>Para pele sensível</li>
                    </ul>
                </p>
            </div>
            <div class="card">
                <img src="img/talco.png" alt="Alternativa 4">
                <h3 class="nam">Talco para Bebês</h3>
                <p class="desc">
                    <ul>
                        <li>Deixa a pele fresca e seca</li>
